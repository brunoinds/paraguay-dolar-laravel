...
namespace Brunoinds\ParaguayDolarLaravel\Store;
...
class StoreLaravelCache
{
    ...
    public function get()
    {
        return Cache::store($this->store)->get('Brunoinds/ParaguayDolarLaravelStore');
    }

    public function set(string $value)
    {
        Cache::store($this->store)->put('Brunoinds/ParaguayDolarLaravelStore', $value);
    }
}